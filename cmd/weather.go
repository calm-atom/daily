...
var weatherCmd = &cobra.Command{
	Use:   "weather",
	Short: "Get today's weather",
	Long: `Daily weather gets the current weather conditions for Gladstone.
It will report the weather description, the current, high, and low temperature
for the day and windspeed.`,
